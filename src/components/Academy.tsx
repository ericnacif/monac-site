...
import { FluxoCaixaPDF } from "../documents/FluxoCaixaPDF.tsx";
  ...
  return (
    ...
    >
      <div>
        ...
        <p
          className="text-xs text-white/40 flex items-center gap-2 mt-4 font-light"
          ...
          <div className="max-w-xl">
            <div className="flex items-center gap-2 mb-4 text-monac-blue">
              ...
              <span
                ...
                style={{ color: "#0047BB", marginBottom: 0 }}
              >
                Monac Academy
              </span>
            </div>
