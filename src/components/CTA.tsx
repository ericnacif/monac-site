...
// Número correto — conforme Footer e FloatingWhatsApp
const WHATSAPP = "https://wa.me/5533997088999";
    ...
    <section className="py-24 bg-monac-blue relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
        <motion.h2
          ...
          style={{ fontFamily: "'Century Gothic', Futura, 'Trebuchet MS', sans-serif", letterSpacing: '-0.02em' }}
        >
          Sua empresa não pode<br />esperar mais.
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-white/70 text-lg md:text-xl mb-10 max-w-2xl mx-auto leading-relaxed font-light"
        ...
        >
          <button
            ...
            style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 700, fontSize: '0.75rem', letterSpacing: '0.15em' }}
          >
            Começar Agora
